...
- Treat `manual_required_captcha`, `manual_required_mfa`, and `manual_required_sso` as handoff points for user/manual action. Do not keep trying selectors, unrelated profiles, or repeated submits.
