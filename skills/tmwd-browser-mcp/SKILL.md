...
- `browser_tab_lifecycle.finalize_task` is the normal finalizer for Codex tasks that used browser67 managed tabs. Run it before final response/handoff for the current `workspace_key` or `task_id`, and report whether tabs were closed and close-verified or intentionally kept.
