    ...
    inputSchema: {
      ...
      properties: {
        ...
        active: {
          type: "boolean",
          default: false,
          description: "Compatibility override for tab activation inside its window. New managed tabs default to background. Use focus_policy=foreground for an intentional visible handoff.",
        },
        focus_policy: {
          type: "string",
        ...
        focus_lease_timeout_ms: {
          ...
          minimum: 1_000,
          maximum: 120_000,
          description: "Bounded temporary foreground lease TTL for operations that require real focus.",
        },
