...
function compactProvider(provider = {}) {
  return {
    ...
    platform_supported: provider.platform_supported === true,
...
function summarize(args = {}, capabilities = {}) {
  ...
  return {
    ...
    supported_platforms: compact.supported_platforms,
    platform_supported: compact.platform_supported,
    python: compact.checks?.python,
    python_candidate_source: compact.checks?.python_candidate_source,
    python_selection_reason: compact.checks?.python_selection_reason,
    python_candidates: Array.isArray(compact.checks?.python_candidates) ? compact.checks.python_candidates : [],
