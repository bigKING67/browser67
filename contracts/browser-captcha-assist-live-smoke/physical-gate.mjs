  ...
  return {
    ...
    native_input: physicalAssist.native_input
      ? {
        ...
        x: physicalAssist.native_input.x,
        y: physicalAssist.native_input.y,
        count: physicalAssist.native_input.count,
        ...
        foreground_activation: physicalAssist.native_input.foreground_activation,
