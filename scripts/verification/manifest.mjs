...
const entries = [
  ...
  npmEntry("readme", "check:readme", { changed_paths: ["README.md", "docs/**", "THIRD_PARTY_NOTICES.md", "UPSTREAM.lock.json", "UPSTREAM.review.json", "contracts/readme-contract.mjs", "package.json"] }),
  ...
  npmEntry("upstream-lock-contract", "check:upstream-lock", { changed_paths: ["UPSTREAM.lock.json", "scripts/upstream-lock.mjs", "contracts/upstream-lock-contract.mjs"] }),
  npmEntry("extension-upstream-sync-contract", "check:extension-upstream-sync", { changed_paths: ["extension/**", "scripts/sync-genericagent-extension.mjs", "UPSTREAM.review.json", "contracts/extension-upstream-sync-contract.mjs"] }),
  ...
  npmEntry("extension-upstream-check", "extension:check", { changed_paths: ["extension/**", "scripts/sync-genericagent-extension.mjs", "UPSTREAM.lock.json", "UPSTREAM.review.json"] }),
  ...
  npmEntry("browser-live", "check:live", { requirements: ["node", "tmwd_hub", "browser67_extension"] }),
...
const tiers = {
  ...
  check: {
    ...
    steps: [
      ...
      "runtime-cleanup", "task-templates", "regression-matrix", "verification-manifest", "upstream-audit-contract", "upstream-lock-contract", "extension-upstream-sync-contract", "upstream-review-contract",
  ...
  verify: {
    ...
    steps: [
      ...
      "readiness", "live-doctor", "browser-live", "js-reverse-live", "managed-tab-live", "tmwd-performance-live", "screenshot-live", "auth-live", "captcha-assist-live",
  ...
  live: {
    ...
    steps: ["live-doctor", "browser-live", "js-reverse-live", "managed-tab-live", "tmwd-performance-live", "auth-live", "captcha-assist-live", "screenshot-live"],
  },
  platform: {
