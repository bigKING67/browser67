...
const entries = [
  ...
  npmEntry("codex-host-finalizer", "check:codex-host-finalizer"),
...
const tiers = {
  ...
  check: {
    ...
    steps: [
      ...
      "project-structure", "setup-extension", "extension-build", "extension-managed-runtime", "extension-install-doctor", "performance-smoke",
      "extension-reload-live-contract",
      "runtime-cleanup", "task-templates", "regression-matrix", "verification-manifest", "upstream-audit-contract", "upstream-review-contract",
      "upstream-review-refresh-contract", "codex-host-finalizer", "tmwd-runtime-dispose", "tmwd-transport-health", "extension-bridge",
