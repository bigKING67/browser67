...
const entries = [
  ...
  npmEntry("verification-runner", "check:verification-runner", { changed_paths: ["scripts/run-verification.mjs", "contracts/verification-runner-contract.mjs", "package.json"] }),
