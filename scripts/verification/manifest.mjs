...
const tiers = {
  ...
  check: {
    ...
    steps: [
      ...
      "runtime-cleanup", "task-templates", "regression-matrix", "verification-manifest", "upstream-audit-contract", "extension-upstream-sync-contract", "upstream-review-contract",
