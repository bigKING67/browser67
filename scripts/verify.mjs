...
function buildCommands(managedTabBaselineFile) {
  return [
    ...
    { command: "npm", args: ["run", "upstream:review-refresh-plan"] },
    { command: "npm", args: ["run", "check:upstream-audit"] },
    { command: "npm", args: ["run", "check:upstream-review"] },
    { command: "npm", args: ["run", "check:upstream-review-refresh-plan"] },
    { command: "npm", args: ["run", "check:js-reverse-upstream-audit"] },
    { command: "npm", args: ["run", "check:js-reverse-absorption-matrix"] },
    { command: "npm", args: ["run", "js-reverse:upstream-audit", "--", "--json"] },
    { command: "npm", args: ["run", "check:active-skill-sync"] },
    { command: "npm", args: ["run", "skills:active:diff"] },
    { command: "npm", args: ["run", "check:skills-roots-audit"] },
    { command: "npm", args: ["run", "skills:roots:audit"] },
    ...
    { command: "npm", args: ["run", "check:verification-manifest"] },
    ...
    { command: "npm", args: ["run", "check:job-persistence"] },
    ...
    { command: "npm", args: ["run", "check:screenshot-live"] },
    ...
    { command: "npm", args: ["run", "check:native-live"] },
